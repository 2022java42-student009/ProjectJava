...
<jsp:include page="/indexheader.jsp"/>
	...
	<form action="/ProjectJava/AccountServlet" method="post">
		メールアドレス<br> <input type="email" name="email" class="intxt" placeholder="(例)hogehoge@example.com" required><br> <br> 
		パスワード<br> <input type="password" name="pass" class="intxt" required>
